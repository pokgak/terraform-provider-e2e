...
- `plan` : (Required)(String) The name of the Plan. To find the available plan names, please refer to our [`API Documentation`](https://docs.e2enetworks.com/api/myaccount/#/paths/images/get).
